...
#include "QuitDreaming/Variant_TwinStick/AI/TwinStickNPC.h"
...
QUITDREAMING_API UClass* Z_Construct_UClass_ATwinStickNPC();
QUITDREAMING_API UClass* Z_Construct_UClass_ATwinStickNPC_NoRegister();
QUITDREAMING_API UClass* Z_Construct_UClass_ATwinStickNPCDestruction_NoRegister();
QUITDREAMING_API UClass* Z_Construct_UClass_ATwinStickPickup_NoRegister();
...
struct Z_Construct_UClass_ATwinStickNPC_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bHit_MetaData[] = {
		{ "Category", "NPC" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** If true, this NPC has already been hit by a projectile and is being destroyed */" },
#endif
		{ "ModuleRelativePath", "Variant_TwinStick/AI/TwinStickNPC.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "If true, this NPC has already been hit by a projectile and is being destroyed" },
#endif
	};
#endif // WITH_METADATA
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_QuitDreaming_Source_QuitDreaming_Variant_TwinStick_AI_TwinStickNPC_h__Script_QuitDreaming_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATwinStickNPC, ATwinStickNPC::StaticClass, TEXT("ATwinStickNPC"), &Z_Registration_Info_UClass_ATwinStickNPC, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATwinStickNPC), 2471116335U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_QuitDreaming_Source_QuitDreaming_Variant_TwinStick_AI_TwinStickNPC_h__Script_QuitDreaming_436846138(TEXT("/Script/QuitDreaming"),
	Z_CompiledInDeferFile_FID_QuitDreaming_Source_QuitDreaming_Variant_TwinStick_AI_TwinStickNPC_h__Script_QuitDreaming_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_QuitDreaming_Source_QuitDreaming_Variant_TwinStick_AI_TwinStickNPC_h__Script_QuitDreaming_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
