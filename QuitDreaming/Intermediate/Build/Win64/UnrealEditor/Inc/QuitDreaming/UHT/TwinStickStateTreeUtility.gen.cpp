...
#include "QuitDreaming/Variant_TwinStick/AI/TwinStickStateTreeUtility.h"
...
QUITDREAMING_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData();
QUITDREAMING_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerTask();
...
class UScriptStruct* FStateTreeGetPlayerInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData, (UObject*)Z_Construct_UPackage__Script_QuitDreaming(), TEXT("StateTreeGetPlayerInstanceData"));
	}
...
class UScriptStruct* FStateTreeGetPlayerTask::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerTask, (UObject*)Z_Construct_UPackage__Script_QuitDreaming(), TEXT("StateTreeGetPlayerTask"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_QuitDreaming_Source_QuitDreaming_Variant_TwinStick_AI_TwinStickStateTreeUtility_h__Script_QuitDreaming_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FStateTreeGetPlayerInstanceData::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData_Statics::NewStructOps, TEXT("StateTreeGetPlayerInstanceData"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerInstanceData), 1612787866U) },
		{ FStateTreeGetPlayerTask::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerTask_Statics::NewStructOps, TEXT("StateTreeGetPlayerTask"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerTask), 1872309187U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_QuitDreaming_Source_QuitDreaming_Variant_TwinStick_AI_TwinStickStateTreeUtility_h__Script_QuitDreaming_902999406(TEXT("/Script/QuitDreaming"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_QuitDreaming_Source_QuitDreaming_Variant_TwinStick_AI_TwinStickStateTreeUtility_h__Script_QuitDreaming_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_QuitDreaming_Source_QuitDreaming_Variant_TwinStick_AI_TwinStickStateTreeUtility_h__Script_QuitDreaming_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
